...
//            resizeImageToTarget();
    ...
    private void processFaceContourDetectionResult(List<Face> faces) {
        ...
        for (int i = 0; i < faces.size(); ++i) {
            ...
            final FaceContourGraphic faceGraphic = new FaceContourGraphic(mGraphicOverlay, new PointDrawListener() {
                @Override
                public void onSuccess(PointF foreheadPontF) {
    ...
    private void getPixelValue(int i) {
        int graySum = 0;
        //int pixelValue = 0;
        double a=850;
        double b=1099.04;
//        double m=14.72071807;
//        double c=91165.4968362689;
      ...
      //  showToast(String.valueOf(pixelValue));

        //to show oily or dry skin

//        double micvalue= (m*this.pixelValue)+c;

        if(this.pixelValue<a){
            Toast.makeText(this, "dry", Toast.LENGTH_LONG).show();
        }
        else if(this.pixelValue>b){
            Toast.makeText(this, "oily", Toast.LENGTH_LONG).show();
        }
        else{
            Toast.makeText(this, "mixed", Toast.LENGTH_LONG).show();
        }
    }
    private void oilyanddry() {
        /*int a = 1500;
        int pixelValue = String.valueOf(pixelValue);
